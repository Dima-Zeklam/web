...
var input = prompt("what is your favourit yhing in Taekwondo ? poomsae, show's or fight ","poomsae , show's , fight");
...
while( input != "poomsae" &&  input != "show's" && input != "fight"){
 input =prompt("what is your favourit thing in Taekwondo ? poomsae, show's or fight ","poomsae , show's , fight");
}
function start(){
 if(input == "poomsae"){
  change("img1","<img src='https://www.insidethegames.biz/media/image/150153/o/7Q1ULbtrDZstcSPa' alt='Taekwondo pic' width='500' />");
  change("h2","<h2> Poomsae </h2>");
